	...
	var imgDir = "/comun/calendario/images/"			// directory for images ... e.g. var imgDir="/img/"
	...
	var selectYearMessage = "Seleccionar año."
	var selectDateMessage = "Seleccionar [date] como dia." // do not replace [date], it will be replaced by date.
    ...
    */
	...
	if (dom)
	{
		...
		document.write ("<div onclick='bShow=true' id='calendar'	style='z-index:+999;position:absolute;visibility:hidden;'><table	width="+((showWeekNumber==1)?250:220)+" style='font-family:arial;font-size:11px;border-width:1;border-style:solid;border-color:#a0a0a0;font-family:arial; font-size:11px}' bgcolor='#ffffff'><tr background='/comun/calendario/images/calback.jpg'><td background='/comun/calendario/images/calback.jpg'><table width='"+((showWeekNumber==1)?248:218)+"'><tr><td style='padding:2px;font-family:arial; font-size:11px;'><font color='#FFFFFF'><B><span id='caption'></span></B></font></td><td align=right><a href='javascript:hideCalendar()'><IMG SRC='"+imgDir+"close.gif' BORDER='0' ALT='Cerrar'></a></td></tr></table></td></tr><tr><td style='padding:5px' bgcolor=#ffffff><span id='content'></span></td></tr>")
...
//---------------------------------------------TRADUCCION EN ESPAÑOL-----------------------------------------------------------------------------
	...
	function popUpMonth() {
		...
		//crossMonthObj.left = parseInt(crossobj.left) + 50
			var intLeft = parseInt(crossobj.left) + 50;
			crossMonthObj.left = intLeft + "px";
		//crossMonthObj.top =	parseInt(crossobj.top) + 26
			var intTop = parseInt(crossobj.top) + 26;
			crossMonthObj.top = intTop + "px";
...
//modificado
//Dentro del siguiente ciclo se generan los años, en el caso de que sea introcir fecha de nacimiento restale 30---- i>=(yearNow-30)-----
//CAMBIA el siguiente for por este " for	(i=yearNow; i<=(yearNow+4); i++) { " si quieres que los años empizen en el actual en adelante
//DEFINIMOS EL AÑO INICIAL DEL CALENDARIO
//PUEDE QUE VENGAN DEFINIDOS LOS AÑOS EN LA PAGINA PADRE
var AnioInicio = ANIOINICIAL;
var AnioFin = ANIOFINAL;
...
//------------------------------------TERMINAR LA FUNCION EN 0 PARA QUE INICIE EN EL DIA ACTUAL EN LA SIGUIENTE LINEA----------------------------------------------
	...
	document.onkeypress = function hidecal1 () { 
		if (((document.all) ? event.keyCode : event.which)==27) 
		{
			hideCalendar()
		}
	}
